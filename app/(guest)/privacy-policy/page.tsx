export default function PrivacyPolicy() {
    return (
        <div>
            ...
            <p>
                <span>
                    A sua privacidade é importante para nós. É política do West
                    Side Company Unlimited respeitar a sua privacidade em
                    ...
                    <ul>
                        <li>
                            <span>
                                ...
                                veicular publicidade usa um cookie DoubleClick
                                para veicular anúncios mais relevantes em toda a
                        ...
                        <li>
                            <span>
                                ...
                                cookies de publicidade comportamental usados por
                                este site foram projetados para garantir que
                                você forneça os anúncios mais relevantes sempre
                                que possível, rastreando anonimamente seus
                        ...
                        <li>
                            <span>
                                ...
                                acessaram o site através de um dos sites de
                                nossos parceiros, para que possamos creditá-los
                                adequadamente e, quando aplicável, permitir que
                                nossos parceiros afiliados ofereçam qualquer
            ...
            <p>
                <span>
                    ...
                    da informação que o West Side Company Unlimited oferece no
            ...
            <ul>
                ...
                <li>
                    <span>
                        ...
                        lógicos (softwares) do West Side Company Unlimited, de
                        seus fornecedores ou terceiros, para introduzir ou
                        disseminar vírus informáticos ou quaisquer outros
                        sistemas de hardware ou software que sejam capazes de
            ...
            <p>
                <span>
                    Esta política é efetiva a partir de&nbsp;13 January 2024
                    16:44
                </span>
            </p>
        </div>
